...
namespace PokemonClassLibrary
{
    public static class TrainerData
    {
        ...
        public static void InitializeTrainderDataTable()
        {
            ...
            DataColumn dcTrainerName = new DataColumn("TrainerName", typeof(string));
            DataColumn dcTrainerPass = new DataColumn("TrainerPass", typeof(string));

            TrainerDataTable.Columns.Add(dcTrainerId);
            TrainerDataTable.Columns.Add(dcTrainerName);
            TrainerDataTable.Columns.Add(dcTrainerPass);

            DataColumn[] primaryKey = { dcTrainerId };
            TrainerDataTable.PrimaryKey = primaryKey;
        }
